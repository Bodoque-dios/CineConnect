...
const burro = {
  ...
  7: "¡Wow! Solo un amigo dice la verdad tan cruda",
  8: "¿Eres…...muy alto?",
  9: "Nones",
  10: {
...
const Chat = () => {
  ...
  return (
    <div className="via-primary-951 relative h-screen max-h-screen w-full overflow-hidden bg-gradient-to-b from-primary-950  to-primary-950 font-inter">
      <div className="flex items-center justify-between">
        <div className="m-4 flex items-center">
          ...
          />
          <h1 className="pl-3 text-2xl font-bold text-rojovintage-500">
            Burro
          </h1>
        </div>
        <Link to="/chat">
...
function Mensaje({ wasSent, mensaje }) {
  if (!wasSent) {
    return (
      <div className="ml-4 mt-2 h-fit w-fit  max-w-[70%] rounded bg-azul p-2 py-2 text-white">
        {mensaje}
      </div>
    );
  } else {
    return (
      <div className="mr-4 mt-2 h-fit w-fit  max-w-[70%] self-end rounded bg-rojovintage-500 p-2 py-2">
        {mensaje}
      </div>
    );
  }
